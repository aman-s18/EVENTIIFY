class EventBookingsController < ApplicationController
  ...
  def create
    ...
    # @event_booking.customername = params[:customername]
  ...
  private
    ...
    def event_booking_params
      params.require(:event_booking).permit(:event_id, :user_id, :tickets, :total_price , :customername, :aadhar, :phone_number)
    end
end
